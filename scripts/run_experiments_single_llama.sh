...
# "brando:4_correction:1:${DEFAULT_DNN}:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
...
# "creativeo:4_correction:1:${DEFAULT_DNN}:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
...
"gameo:4_correction:1:${DEFAULT_DNN}:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
...
# "mato:4_correction:1:${DEFAULT_DNN}:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
...
EOF
  ...
  # 设置输出目录前缀
  local output_dir_prefix="${SCRIPT_DIR}/output/ablation_single_type/${categories}/${rewrite_types}/${dnn}/${exp_id}"
