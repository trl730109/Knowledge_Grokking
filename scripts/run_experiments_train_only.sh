...
experiments=(
# "bio:all:1:qwen3-8b:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
# "brand:all:1:qwen3-8b:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
# "creative:all:1:qwen3-8b:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
# "game:all:1:qwen3-8b:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
# "geo:all:1:qwen3-8b:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
"geo:all:1:llama-3.1-8b-instruct:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
# "history:all:1:qwen3-8b:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
# "mat:all:1:qwen3-8b:${DEFAULT_CUDA_DEVICES}:10.0:2e-4:64"
)
...
run_experiment() {
  ...
  # Step 1: 数据合成
  echo ""
  echo "[STEP 1/2] Synthesizing dataset..."
  local syn_output
  ...
  local output_dir="${SCRIPT_DIR}/lora_saved/${dnn}/${exp_id}"
...
EOF
  ...
  echo "  Note: Evaluation will be done in a separate environment"
  echo "========================================"
  echo ""
}
